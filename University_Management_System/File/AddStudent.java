...
class AddStudent
{
	...
	long first1 = (ran.nextLong() % 3000l) + 1000l;
	...
	AddStudent()
	{
		...
		ImageIcon image = new ImageIcon("E:\\JAVA_Projects\\University_Management_System\\img\\Student.jpg");
		lbl15 = new JLabel(image);
		lbl15.setBounds(0,0,730,500);

		lbl1 = new JLabel("New Student Details");
		...
		lbl13.setBounds(40,300,250,30);
		lbl13.setForeground(Color.BLACK);
		lbl13.setFont(new Font("Serif",Font.BOLD,20));

		txt10 = new JTextField();
		txt10.setBounds(170,300,150,30);
		//txt10.setText(""+first1);
		...
		lbl7.setBounds(40,340,150,30);
		lbl7.setForeground(Color.BLACK);
		lbl7.setFont(new Font("Serif",Font.BOLD,20));

		String edu[] = {"Branch", "Computer Science", "Electronics", "Electrical", "Machanical", "Software", "Civil"};
		cb = new JComboBox(edu);
		cb.setBounds(170,340,150,30);
		...
		lbl12.setBounds(340,300,250,30);
		lbl12.setForeground(Color.BLACK);
		lbl12.setFont(new Font("Serif",Font.BOLD,20));

		String dep[] = {"Couse", "B.Tech", "BBA", "BCA", "Bsc", "Msc", "MBA", "BA"};
		cb1 = new JComboBox(dep);
		cb1.setBounds(530,300,150,30);
		...
		btn1.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent ae)
				{
					...
					String cnic = txt12.getText().toString();
					String rNo = txt10.getText().toString(); 
					...
					try
					{
						...
						String query = "INSERT INTO addstudent VALUES('"+name+"', '"+fName+"', '"+age+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+classX+"', '"+classXII+"', '"+cnic+"', '"+rNo+"', '"+education+"', '"+department+"')";
					...
					{
						System.out.println("SQLExeption : " +sqle);
					}
				}
			});
