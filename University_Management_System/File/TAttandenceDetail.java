...
class TAttandenceDetail
{
	...
	public TAttandenceDetail()
	{
		win = new JFrame("Teacher Attandence Detail");

		win.getContentPane().setBackground(Color.WHITE);

		String row[][] = {};

		String column[] = {"ID No", "Date", "Attandence"};
		...
		try
		{
			...
			ResultSet rs = state.executeQuery("SELECT * FROM teacherattendance");
			...
			while(rs.next())
			{
				...
				String data[] = {id,date,attendance};
